...
const routes: Routes = [
  ...
  { path: "edit-fitness-trainer-appointment/:id", component: PlaceFitnessTrainerAppointmentComponent },
  { path: "view-appointment",component: ViewAppointmentComponent },
  { path: "view-appointment/:preference",component: ViewAppointmentComponent },
